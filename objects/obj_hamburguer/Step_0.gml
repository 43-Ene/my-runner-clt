...
//Se o obj_hamburguer estiver posicionado entre o intervalo -64 e +64 no
//eixo y com o obj_clt4
if(y >= obj_clt4.y - 64 && y <= obj_clt4.y + 64)
{
		//O alarme do obj_hamburguer devera ser reativado imediatamente
		//o fazendo respawnar
		alarm[0] = 1;
